...
## Code Style Loading (Required Before Implementation)

Before writing any code, read the appropriate style guide based on file extension:

| File Extension | Style Guide |
|---------------|-------------|
